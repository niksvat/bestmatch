...
#right{  
    ...
    <body>
        ...
        <div id="left">
            ...
            <h3>Q2.What are your views on saving money?
               <br> 
               ...
               <form action="game">
                   ...
                   <input type="radio" name="Answer" value="a" />
                    I think spend money according to need it will save automatically
                    <input type="radio" name="Answer" value="b" />
                    Money saving is needed to be done
                    <input type="radio" name="Answer" value="c" />
                    I never save money which i regret the most.
