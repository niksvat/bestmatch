...
#right{  
    ...
    <body>
        ...
        <div id="left">
            ...
            <h3>Q9. What is one thing you’d like to accomplish by this time next year?
               <br> 
               ...
               <form action="game">
                   ...
                   <input type="radio" name="Answer" value="a" />
                    ...
                    Just study and have a good class performance
                    <input type="radio" name="Answer" value="c" />
                    I want to conquer the world
                    <input type="radio" name="Answer" value="d" />
                    I just do cool things its life where it takes me.
                    <br><br>
